...
{
    $html = '<div class="row social-share-wrapper">';
    ...
    {
        $html = $html . "<div class='facebook'><a target='_blank' href='http://www.facebook.com/sharer.php?u=" . $url . "'><i class=\"fa fa-facebook\" aria-hidden=\"true\"></i> Share Facebook</a></div>";
    }
...
add_shortcode("social", "add_social_share_icons");
